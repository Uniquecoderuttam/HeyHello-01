...
import logo from '../assets/logohey.png'
...
const SignUp = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      ...
      <img className='w-36 h-12 items-center justify-center place-items-center' src={logo} alt="logo" />

        <h1 className="text-3xl font-semibold text-center text-slate-700">
          Signup to
          <span className="text-blue-700"> HeyHello</span>
        </h1>
